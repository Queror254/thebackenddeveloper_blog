...
export default function BlogEditor() {
  ...
  return (
    ...
    <Head>
      ...
      <meta name='author' content='Soubhagyajit Borah'/>    </Head>
    <main>
      <div className="h-screen w-screen flex items-center flex-col">
        ...
        {/* This is the main initialization of the Jodit editor */}
          <JoditEditor 
            ...
            className="w-full h-[70%] mt-10 bg-white text-gray-900"
            />
            <style>
        ...
        >Preview:
        <div className='text-gray-900' name='post_content' id='post_content' dangerouslySetInnerHTML={{ __html: content }}></div>
